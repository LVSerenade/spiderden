...
class MemoryPartSpider(scrapy.Spider):
    name = "memory"
    base_url = 'https://pcpartpicker.com/'
    
    # This slug is what will trigger the fetching of the data
    magic_slug = "fetch/?page=%d&xslug=&location=&search=&qid=1&scr=1&scr_vw=1263&scr_vh=319&scr_dw=1280&scr_dh=720&scr_daw=1280&scr_dah=680&scr_ddw=1263&scr_ddh=4145&ms=1578759541261"
   
    type_part = "products/memory/"
